...
var _searchQueryDefault = parcelHelpers.interopDefault(_searchQuery);
...
const PARAMETERS = "?key=34043302-c68d7a8556aecc2a40c20dbe5&image_type=photo&orientation=horizontal&safesearch=true&per_page=10";
const URL = BASE_URL + PARAMETERS;
const searchQuery = new (0, _searchQueryDefault.default)(URL, refs.gallery, refs.loadMoreBtn);
...
document.addEventListener("scroll", (0, _lodash.throttle)((event)=>{
    const scrollPosition = window.scrollY + window.innerHeight;
    const bodyHeight = refs.body.offsetHeight;
    if (scrollPosition === bodyHeight) searchQuery.loadMore();
}, 300));

},{"./search-query":"62uVd","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","lodash":"3qBDj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"62uVd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class SearchQuery {
    ...
    async fetchImages() {
        ...
        try {
            ...
            (0, _notiflixNotifyAio.Notify).success(`Hooray! We found ${this.totalHits} images.`);
    ...
    createCards() {
        this.imagesParameters.map(({ webformatURL , largeImageURL , tags , likes , views , comments , downloads ,  })=>{
            this.markup.push(`<a href="${largeImageURL}" class="gallery-link"><div class="photo-card"><img src="${webformatURL}" alt="${tags}" loading="lazy"><div class="info"><p class="info-item"><b>Likes: ${likes}</b></p><p class="info-item"><b>Views: ${views}</b></p><p class="info-item"><b>Comments: ${comments}</b></p><p class="info-item"><b>Downloads: ${downloads}</b></p></div></div></a>`);
        });
    }
    createLightbox() {
    ...
    scrollDown() {
        const { height: cardHeight  } = this.markupRef.firstElementChild.getBoundingClientRect();
        window.scrollBy({
            top: cardHeight * 2,
            behavior: "smooth"
        });
    ...
    endOfCollection() {
        ...
        (0, _notiflixNotifyAio.Notify).info("Were sorry, but youve reached the end of search results.");
    }
    reset() {
        // this.deactivateLoadMoreBtn();
...
},{"notiflix/build/notiflix-notify-aio":"eXQLZ","simplelightbox":"9ydBq","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eXQLZ":[function(require,module,exports) {
var global = arguments[3];
/*
...
},{}]},["aRq6p","ebWYT"], "ebWYT", "parcelRequirea610")
